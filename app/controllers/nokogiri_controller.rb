...
class NokogiriController < ApplicationController
	...
	def logistics_trace
		...
		logistics_tmp_file = open("https://trackings.post.japanpost.jp/services/srv/search/?requestNo1=cd245505083jp&search=%E8%BF%BD%E8%B7%A1%E3%82%B9%E3%82%BF%E3%83%BC%E3%83%88")
		doc = Nokogiri::HTML(logistics_tmp_file)
		 
		@logistics_details = doc.xpath('//table[@summary="配達状況詳細"]')
		@logistics_histories = doc.xpath('//table[@summary="履歴情報"]')
